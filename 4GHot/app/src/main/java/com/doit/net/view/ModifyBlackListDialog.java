        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!imsi.equals(modifyIMSI)) {
                    ...
                    try {
                        DBBlackInfo blackListInfo = db.selector(DBBlackInfo.class)
                    ...
                    try {
                        DBBlackInfo blackListInfo = UCSIDBManager.getDbManager().selector(DBBlackInfo.class)
                                .where("imsi", "=", modifyIMSI)
                                .findFirst();
                ...
                EventAdapter.call(EventAdapter.ADD_BLACKBOX, BlackBoxManger.MODIFY_NAMELIST+modifyIMSI+"为:"+ imsi
                        + "+" + msisdn+"+"+remark);
                dismiss();
            }
        });
